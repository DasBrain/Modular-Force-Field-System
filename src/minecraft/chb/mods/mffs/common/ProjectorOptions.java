...
public enum ProjectorOptions
{
  ...
  public static void initialize()
  {
    for (ProjectorOptions mach : values())
    {
      ...
      if (ModularForceFieldSystem.ic2found.booleanValue()) RecipesFactory.addRecipe(mach.recipeic, 1, 1, null, mach.item);
      if (ModularForceFieldSystem.uefound.booleanValue()) RecipesFactory.addRecipe(mach.recipeue, 1, 2, null, mach.item);
    }
  }
}
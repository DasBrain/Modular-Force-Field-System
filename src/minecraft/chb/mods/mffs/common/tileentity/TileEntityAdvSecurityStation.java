...
public class TileEntityAdvSecurityStation extends TileEntityMachines
{
  ...
  public void checkslots() {
    ...
    if ((getStackInSlot(39) != null) && (getStackInSlot(38) != null) && 
      ((getStackInSlot(38).getItem() instanceof ItemCardEmpty)) && ((getStackInSlot(39).getItem() instanceof ItemCardPersonalID)))
    {
  ...
  public boolean RemoteInventory(String username, SecurityRight right)
  {
    for (int a = 35; a >= 1; a--) {
      if ((getStackInSlot(a) != null) && 
        (getStackInSlot(a).getItem() == ModularForceFieldSystem.MFFSItemIDCard)) {
      ...
      for (Slot slot : slots) {
        ...
        if (stack != null) {
          if ((stack.getItem() instanceof ItemAccessCard)) {
            ((ItemAccessCard)stack.getItem()); if (ItemAccessCard.getvalidity(stack) > 0) {
              ((ItemAccessCard)stack.getItem()); if (ItemAccessCard.getlinkID(stack) == getDeviceID()) {
                ((ItemAccessCard)stack.getItem()); if (ItemAccessCard.hasRight(stack, right))
                {
                  ((ItemAccessCard)stack.getItem()); if (!ItemAccessCard.getforAreaname(stack).equals(getDeviceName())) {
                    ((ItemAccessCard)stack.getItem()); ItemAccessCard.setforArea(stack, this);
                  }
                  return true;
                }
              }
  ...
  public void onNetworkHandlerEvent(int key, String value)
  {
    ...
    case 101:
      if ((getStackInSlot(1) != null) && 
        ((getStackInSlot(1).getItem() instanceof ItemAccessCard)))

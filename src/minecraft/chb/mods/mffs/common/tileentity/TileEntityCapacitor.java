  ...
  implements INetworkHandlerEventListener, IForceEnergyStorageBlock
{
  ...
  public int getStorageMaxPower()
  {
    if ((getStackInSlot(0) != null) && 
      (getStackInSlot(0).getItem() == ModularForceFieldSystem.MFFSitemupgradecapcap))
    {
  ...
  private void checkslots(boolean init)
  {
    ...
    if (getStackInSlot(2) != null) {
      if ((getStackInSlot(2).getItem() instanceof IForceEnergyItems)) {
        if ((getPowerlinkmode() != 3) && (getPowerlinkmode() != 4)) setPowerlinkmode(3);
      ...
      {
        if ((getPowerlinkmode() != 0) && (getPowerlinkmode() != 1) && (getPowerlinkmode() != 2)) setPowerlinkmode(0);
      }
    }
  }
      ...
      case 0:
        if ((getPercentageStorageCapacity() >= 95) && (getPercentageCapacity() != 100))
        {
          if (freeStorageAmount > PowerTransferrate)
          {
            ...
            consumePowerfromStorage(freeStorageAmount, false); }  } break;
      case 1:
        if (getPercentageCapacity() < getPercentageStorageCapacity())
        {
          if (balancelevel > PowerTransferrate)
          {
            ...
            consumePowerfromStorage(balancelevel, false); }  } break;
      case 2:

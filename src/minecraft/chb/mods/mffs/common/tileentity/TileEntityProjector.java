  ...
  implements IModularProjector
{
  ...
  public void checkslots()
  {
    ...
    if ((hasOption(ModularForceFieldSystem.MFFSProjectorOptionCamouflage, true)) && 
      (getforcefieldblock_meta() != ForceFieldTyps.Camouflage.ordinal())) {
    ...
    if ((hasOption(ModularForceFieldSystem.MFFSProjectorOptionZapper, true)) && 
      (getforcefieldblock_meta() != ForceFieldTyps.Zapper.ordinal())) {
    ...
    if (hasValidTypeMod()) {
      ...
      for (int spot = 2; spot <= 4; spot++) {
        if ((getStackInSlot(spot) != null) && 
          (!modTyp.supportsOption(getStackInSlot(spot).getItem()))) {
          dropplugins(spot, this);
        }

        if ((getStackInSlot(spot) != null) && 
          ((getStackInSlot(spot).getItem() instanceof ItemProjectorOptionForceFieldJammer)) && (isPowersourceItem())) {
          dropplugins(spot, this);
        }

        if ((getStackInSlot(spot) != null) && 
          ((getStackInSlot(spot).getItem() instanceof ItemProjectorOptionFieldFusion)) && (isPowersourceItem())) {
          dropplugins(spot, this);
        }

        if ((getStackInSlot(spot) != null) && 
          ((getStackInSlot(spot).getItem() instanceof ItemProjectorOptionDefenseStation)) && (isPowersourceItem())) {
          dropplugins(spot, this);
        }
      ...
      if ((getStackInSlot(12) != null) && 
        ((getStackInSlot(12).getItem() instanceof ItemCardSecurityLink)) && (isPowersourceItem())) {
        dropplugins(12, this);
      }
  ...
  private boolean calculateField(boolean addtoMap) {
    ...
    if (hasValidTypeMod()) {
      Set tField = new HashSet();
      Set tFieldInt = new HashSet();
      ...
      for (PointXYZ pnt : tFieldInt)
      {
        if (pnt.Y + this.yCoord < 255) {
          ...
          if (calculateBlock(tp))
            this.field_interior.add(tp); else return false;
        }
  ...
  public boolean Forcefielddefine(PointXYZ png, boolean addtoMap)
  {
    for (ItemProjectorOptionBase opt : getOptions(true))
    {
      if (((opt instanceof ItemProjectorOptionForceFieldJammer)) && 
        (((ItemProjectorOptionForceFieldJammer)opt).CheckJammerinfluence(png, this.worldObj, this))) {
        return false;
      }

      if (((opt instanceof ItemProjectorOptionFieldFusion)) && 
        (((ItemProjectorOptionFieldFusion)opt).checkFieldFusioninfluence(png, this.worldObj, this))) {
        return true;
      }
  ...
  public void destroyField()
  {
    ...
    Map FieldFusion = Linkgrid.getWorldMap(this.worldObj).getFieldFusion();
      ...
      case 1:
        if (!isPowersourceItem())
        {
          if (getaccesstyp() != 3)
          {
            ...
            else setaccesstyp(getaccesstyp() + 1);
          }
        }
        break;
      }
  ...
  public boolean isItemValid(ItemStack par1ItemStack, int Slot)
  {
    ...
    if ((Slot == 11) && (par1ItemStack.itemID < 4096) && (hasOption(ModularForceFieldSystem.MFFSProjectorOptionCamouflage, true))) return true;
    ...
    if (hasValidTypeMod())
    {
      ...
      case 4:
        ...
        if ((par1ItemStack.getItem() instanceof ItemProjectorOptionTouchDamage)) {
          for (int spot = 2; spot <= 4; spot++) {
            if ((getStackInSlot(spot) != null) && 
              ((getStackInSlot(spot).getItem() instanceof ItemProjectorOptionCamoflage))) {
              return false;
            }
          }
        }
        ...
        if ((par1ItemStack.getItem() instanceof ItemProjectorOptionCamoflage)) {
          for (int spot = 2; spot <= 4; spot++) {
            if ((getStackInSlot(spot) != null) && 
              ((getStackInSlot(spot).getItem() instanceof ItemProjectorOptionTouchDamage))) {
              return false;
            }
          }
  ...
  public List getOptions(boolean includecheckall)
  {
    ...
    for (int place = 2; place < 5; place++) {
      if ((getStackInSlot(place) != null) && 
        ((getStackInSlot(place).getItem() instanceof ItemProjectorOptionBase))) {

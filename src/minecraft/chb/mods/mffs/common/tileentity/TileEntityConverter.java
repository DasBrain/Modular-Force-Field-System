  ...
  implements IEnergySource
{
  ...
  public void onNetworkHandlerEvent(int key, String value)
  {
    ...
    if (getIC_Output() == 0) {
      if (key == 200) {
        if (value.equalsIgnoreCase("+")) {
          switch (this.IC_Outputpacketsize) { case 1:
            this.IC_Outputpacketsize = 32; break;
          case 32:
            this.IC_Outputpacketsize = 128; break;
          case 128:
            this.IC_Outputpacketsize = 512; break;
          case 512:
            this.IC_Outputpacketsize = 2048; break;
          case 2048:
            this.IC_Outputpacketsize = 1;
          }
        }
        if (value.equalsIgnoreCase("-")) {
          switch (this.IC_Outputpacketsize) { case 1:
            this.IC_Outputpacketsize = 2048; break;
          case 32:
            this.IC_Outputpacketsize = 1; break;
          case 128:
            this.IC_Outputpacketsize = 32; break;
          case 512:
            this.IC_Outputpacketsize = 128; break;
      ...
      if (key == 201) {
        if (value.equalsIgnoreCase("+")) {
          if (this.IC_Outputpacketamount == 9)
            this.IC_Outputpacketamount = 1;
          else this.IC_Outputpacketamount += 1;
        }
        if (value.equalsIgnoreCase("-")) {
    ...
    if (getUE_Output() == 0)
    {
      if (key == 202) {
        if (value.equalsIgnoreCase("+")) {
          switch (this.UE_Outputvoltage) { case 60:
            this.UE_Outputvoltage = 120; break;
          case 120:
            this.UE_Outputvoltage = 240; break;
          case 240:
        ...
        if (value.equalsIgnoreCase("-")) {
          switch (this.UE_Outputvoltage) { case 60:
            this.UE_Outputvoltage = 240; break;
          case 120:
            this.UE_Outputvoltage = 60; break;
          case 240:
            this.UE_Outputvoltage = 120;
          }
        }

  ...
  implements ISidedInventory
{
  ...
  public int getActionDistance()
  {
    if ((getStackInSlot(3) != null) && 
      (getStackInSlot(3).getItem() == ModularForceFieldSystem.MFFSProjectorFFDistance)) {
  ...
  public int getInfoDistance()
  {
    if ((getStackInSlot(2) != null) && 
      (getStackInSlot(2).getItem() == ModularForceFieldSystem.MFFSProjectorFFDistance)) {
  ...
  public boolean hasSecurityCard()
  {
    if ((getStackInSlot(1) != null) && 
      (getStackInSlot(1).getItem() == ModularForceFieldSystem.MFFSItemSecLinkCard)) {
      return true;
    }
  ...
  public void scanner()
  {
    try
    {
      ...
      if (sec != null)
      {
        ...
        List infoLivinglist = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getBoundingBox(xmininfo, ymininfo, zmininfo, xmaxinfo, ymaxinfo, zmaxinfo));
        List actionLivinglist = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getBoundingBox(xminaction, yminaction, zminaction, xmaxaction, ymaxaction, zmaxaction));
      ...
      if (sec != null)
      {
        ...
        case 4:
          if (((Living instanceof EntityMob)) || ((Living instanceof EntityAmbientCreature)) || ((Living instanceof EntitySlime)) || ((Living instanceof EntityGhast))) {
            Living.setEntityHealth(0);
            this.NPClist.remove(Living);
            consumePower(ModularForceFieldSystem.DefenceStationKillForceEnergy, false); } break;
        case 5:
    ...
    if (hasPowerSource())
    {
      if (sec != null)
      {
        ...
        case 0:
          if (!sec.isAccessGranted(player.username, SecurityRight.SR))
          {
            player.addChatMessage("!!! [Area Defence]  get out immediately you have no right to be here!!!"); } break;
        case 1:
          if (consumePower(ModularForceFieldSystem.DefenceStationKillForceEnergy, true))
          {
            if (!sec.isAccessGranted(player.username, SecurityRight.SR))
  ...
  public void onNetworkHandlerEvent(int key, String value)
  {
    if (!isActive()) {
      ...
      case 101:
        ...
        else setActionmode(getActionmode() + 1);

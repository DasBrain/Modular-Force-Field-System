  ...
  public boolean onItemUseFirst(ItemStack stack, EntityPlayer entityplayer, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ)
  {
    ...
    if (ffworldmap != null) {
      ...
      if ((projector != null) && (generator != null))
      {
        if (projector.isActive())
        {
          ...
          case 0:
            ...
            for (Slot slot : slots) {
              ...
              if ((playerstack != null) && 
                ((playerstack.getItem() instanceof ItemDebugger))) {
                passtrue = true;
                break;
              }
        ...
        (projector.getStackInSlot(projector.getPowerlinkSlot()) != null) && 
        (!(projector.getStackInSlot(projector.getPowerlinkSlot()).getItem() instanceof ItemCardPowerLink))) {
